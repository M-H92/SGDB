...
const _linkDefinitions = [
  ...
  { name: "2) Relations", url: `${ROOT_PATH}/${PATH}/chapters/2` },
  { name: "3) Identités", url: `${ROOT_PATH}/${PATH}/chapters/3` },
  {
  ...
  { name: "5) Cardinalité", url: `${ROOT_PATH}/${PATH}/chapters/5` },
  {
    ...
    url: `${ROOT_PATH}/${PATH}/chapters/6`,
  },
  { name: "7) Propriétaires", url: `${ROOT_PATH}/${PATH}/chapters/7` },
  {
